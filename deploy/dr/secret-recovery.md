...
# update deploy/bootstrap/wireguard/*.conf.example PublicKey fields
...
template at `deploy/bootstrap/host-prep/netplan/wk-2.yaml.example` ships with a
placeholder.
...
`deploy/bootstrap/host-prep/firewall/edge-allowlist.env`. Then re-apply
