...
| `ADMIN_SSH_ALLOW_IP` (current home IP) | Operator-specific, changes when ISP rotates | Look up at `https://ifconfig.me` and put in `deploy/bootstrap/host-prep/firewall/edge-allowlist.env` |
